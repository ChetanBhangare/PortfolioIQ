...
def status():
    ...
    for t in DEFAULT_ASSET_UNIVERSE:
        ...
        except Exception as e: out.append({"ticker":t,"available":False,"error":str(e)})
    return {"storage_mode":s.storage_mode,"bucket":s.s3_bucket if s.storage_mode=="s3" else None,"datasets":out}
